...
/** @brief Set overflow 16us, prescaler 001 --> 1 */
#define TIM2_overflow_16us()    TCCR2B &= ~((1<<CS12) | (1<<CS11)); TCCR1B |= (1<<CS10);
/** @brief Set overflow 128us, prescaler 010 --> 8 */
#define TIM2_overflow_128us()   TCCR2B &= ~((1<<CS12) | (1<<CS11)); TCCR2B |= (1<<CS10);
/** @brief Set overflow 512ums, prescaler 011 --> 32 */
#define TIM2_overflow_512us()   TCCR2B &= ~(1<<CS12); TCCR2B |= (1<<CS11) | (1<<CS10);
/** @brief Set overflow 1ms, prescaler 100 --> 64 */
#define TIM2_overflow_1ms()     TCCR2B &= ~(1<<CS12); TCCR2B |= (1<<CS11) | (1<<CS10);
/** @brief Set overflow 2ms, prescaler 101 --> 256 */
#define TIM2_overflow_2ms()     TCCR2B &= ~((1<<CS12) | (1<<CS10)); TCCR2B |= (1<<CS11);
/** @brief Set overflow 4ms, prescaler 110 --> 512 */
